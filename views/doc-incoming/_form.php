...
//                       'value' => date('Y-m-d'),
                ...
                <div class="col-md-4">
                    <?= $form->field($model, 'from_ref_client_id')->widget(Select2::classname(), [
                    ...
                    ])->label("Qaysi mijozdan"); ?>
                </div>
                <div class="col-md-4">
                    <?= $form->field($model, 'to_hr_department_id')->widget(Select2::classname(), [
