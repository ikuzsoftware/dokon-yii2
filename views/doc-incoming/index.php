...
$this->title = Yii::t('app', 'Kirim hujjati');
...
<!--'visibleButtons' => [-->
<!--'view' => P::can('mechanical-doc/' . $slug . '/view'),-->
<!--'update' => function ($model) use ($slug) {-->
<!--return P::can('mechanical-doc/' . $slug . '/update') && $model->status < $model::STATUS_SAVED;-->
<!--},-->
<!--'delete' => function ($model) use ($slug) {-->
<!--return P::can('mechanical-doc/' . $slug . '/delete') && $model->status < $model::STATUS_SAVED;-->
<!--}-->
<!--],-->
<!--'buttons' => [-->
