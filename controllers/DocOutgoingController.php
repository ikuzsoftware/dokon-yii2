 ...
 */
class DocOutgoingController extends Controller
{
    /**
     * @inheritDoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search($this->request->queryParams, WmsDocuments::DOC_TYPE_OUT);
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            $response =  $model::setDocSave([
                ...
                'doc_type' => WmsDocuments::DOC_TYPE_OUT,
            ]);
            if ($response['success']) {
