...
/**
 * This is the model class for table "ref_currency_type".
 *
 * @property int $id
 ...
 */
class RefCurrencyType extends BaseModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasMany(WmsDocumentItems::className(), ['currency_type_id' => 'id']);
    }
